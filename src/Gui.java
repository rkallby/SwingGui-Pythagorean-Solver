...
double variable1,variable2,answer;
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        ...
        firstValue  = Integer.parseInt(textField1.getText());
        secondValue = Integer.parseInt(textField3.getText());
        double answer = Math.pow((Math.pow(firstValue, 2)+ Math.pow(secondValue, 2)), .5);
        label1.setText(Double.toString(answer));
